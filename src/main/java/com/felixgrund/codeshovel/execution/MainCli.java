...
public class MainCli {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println(System.getProperty("user.dir") + "/" + repositoryName + "-" + functionName + "-" + functionStartLine);
	...
	static Option newOption(String name, boolean hasArg, String desc, boolean required) {
